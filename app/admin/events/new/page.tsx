...
<div>
<label style={{display:'block',fontSize:'12px',fontWeight:500,color:'#374151',marginBottom:'8px'}}>Preview images <span style={{fontWeight:400,color:'#9ca3af'}}>(up to 10 key photos)</span></label>
<div
onDrop={handleDrop}
...
<input value={driveLink} onChange={(e)=>setDriveLink(e.target.value)} placeholder='https://drive.google.com/drive/folders/...' style={{width:'100%',border:'1px solid #e5e7eb',borderRadius:'6px',padding:'8px 10px',fontSize:'13px',outline:'none'}}/>
<div style={{fontSize:'11px',color:'#9ca3af',marginTop:'4px'}}>Paste your Google Drive folder link — viewers can access all photos from here</div>
</div>
